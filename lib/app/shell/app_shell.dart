...
/// supplies destinations and, for the accounts branch, the master-detail
/// secondary pane (rendered by the scaffold on expanded layouts only).
///
...
class _AppShellState extends State<AppShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return AdaptiveScaffold(
      ...
      secondaryBody: navigationShell.currentIndex == _accountsBranch
