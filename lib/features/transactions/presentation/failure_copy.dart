...
/// One place for user-facing failure copy in the transactions feature.
/// English-only until the l10n pass in Phase 10.
String transactionsFailureCopy(Object failure) {
  return switch (failure) {
    ...
    ValidationFailure() => 'That request wasn\u2019t accepted. Try again.',
